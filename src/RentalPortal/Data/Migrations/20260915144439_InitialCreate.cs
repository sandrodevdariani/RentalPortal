        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Leases_AspNetUsers_TenantUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LandlordName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    LandlordPhone = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Residences_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StatusChanges_AspNetUsers_ChangedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Residences_ApplicationId",
                table: "Residences",
                column: "ApplicationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatusChanges_ChangedByUserId",
                table: "StatusChanges",
